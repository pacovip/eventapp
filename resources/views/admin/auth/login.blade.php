                                ...
                                <div class="block block-themed block-fx-shadow mb-0">
                                        ...
                                        <div class="block-options">
                                            @if (Route::has('admin.password.request'))
                                                <a class="btn btn-link" href="{{ route('admin.password.request') }}">
                                                    <a class="btn-block-option font-size-sm" href="{{ route('admin.password.request') }}">{{ __('Mot de passe oublié ?') }}</a>
                                    ...
                                    <div class="block-content">
                                        <div class="p-sm-3 px-lg-4 py-lg-5">
                                            <h1 class="mb-2">Admin - Backoffice</h1>
                                            <p>Connectez-vous.</p>
                                                    ...
                                                    @if($errors->has('error'))                                                                                                                        
                                                        @foreach ($errors->get('error') as $message)
                                                            <div class="form-group">
                                                                <span class="text-exception" style="color: red;" role="alert">
                                                                {{$message}}
                                                                </span>
                                                            </div>
                                                        @endforeach                                                        
