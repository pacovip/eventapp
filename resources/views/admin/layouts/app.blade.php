...
<html lang="{{ config('app.locale') }}">
    <head>
        ...
        <link rel="icon" sizes="192x192" type="image/png" href="{{ asset('src/media/favicons/favicon-192x192.png') }}">
    ...
    <body>
            ...
            <aside id="side-overlay" class="font-size-sm">
                ...
                <div class="content-header border-bottom">
                    ...
                    <a class="img-link mr-1" href="javascript:void(0)">
                        <img class="img-avatar img-avatar32" src="{{asset('src/media/avatars/avatar10.jpg')}}" alt="">
                    </a>
                    <!-- END User Avatar -->

                    <!-- User Info -->
                    <div class="ml-2">
                        <a class="link-fx text-dark font-w600" href="javascript:void(0)">{{Auth::guard('admin')->user()->name}}</a>
                    </div>
                    <!-- END User Info -->
            ...
            <nav id="sidebar" aria-label="Main Navigation">
                ...
                <div class="content-header bg-white-5">
                    ...
                    <a class="font-w600 text-dual" href="{{url('admin/')}}">
                        ...
                        <span class="smini-hide">
                            <span class="font-w700 font-size-h5">{{ env('APP_NAME') }}</span> <span class="font-w400"></span>
                        </span>
                    </a>
                    <!-- END Logo -->
                ...
                <div class="content-side content-side-full">
                    <ul class="nav-main">
                        ...
                        <li class="nav-main-item">
                            <a class="nav-main-link" href="{{url('admin/event')}}">
                        ...
                        <li class="nav-main-item">
                            <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="false" href="#">
                                ...
                                <span class="nav-main-link-name">Parameters</span>
                            </a>
                            <ul class="nav-main-submenu">
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="{{url('admin/city')}}">
                                        <span class="nav-main-link-name">City</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="{{url('admin/town')}}">
                                        <span class="nav-main-link-name">Town</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="{{url('admin/district')}}">
                                        <span class="nav-main-link-name">District</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="{{url('admin/typeevent')}}">
                                        <span class="nav-main-link-name">Type d'évènement</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="dropdown d-inline-block ml-2">
                            <button type="button" class="btn btn-sm btn-dual" id="page-header-user-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="rounded" src="{{asset('src/media/avatars/avatar10.jpg')}}" alt="{{Auth::guard('admin')->user()->name}}" style="width: 18px;">
                            ...
                            <div class="dropdown-menu dropdown-menu-right p-0 border-0 font-size-sm" aria-labelledby="page-header-user-dropdown">
                                <div class="p-3 text-center bg-primary">
                                    ...
                                    <h6 class="text-white" style="font-weight: 100;">{{Auth::guard('admin')->user()->email}}</h6>
                                </div>
                                <div class="p-2">
                                    
                                    <a class="dropdown-item d-flex align-items-center justify-content-between" href="{{url('admin/profile')}}">
                                        <span>Profile</span>
                                        <span>
                ...
                <div class="content py-3">
                    <div class="row font-size-sm">
                        ...
                        <div class="col-sm-6 order-sm-1 py-1 text-center text-sm-left">
                            <a class="font-w600" href="https://1.envato.market/xWy" target="_blank">Event App</a> &copy; <span data-toggle="year-copy"></span>
                        </div>
                    </div>
                </div>
            </footer>
        ...
        <!-- OneUI Core JS -->
        <script src="{{ asset('src/js/oneui.core.min.js')}}"></script>
        <script src="{{ asset('src/js/oneui.app.min.js') }}"></script>
        <!-- Laravel Scaffolding JS -->
        <script src="{{ asset('src/js/laravel.app.js') }}"></script>
